 ...
 * @author 1GDAW04
 */
public class vModJugador extends javax.swing.JFrame {
    ...
    String nickname;
    Equipo equipo;
    public vModJugador(int idJugador) {
        try {
            initComponents();
            ...
            colocarDatos(BD.tablaJugadores.consultaByIdPersona(idJugador));
        } catch (Exception ex) {
            Logger.getLogger(vModJugador.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void colocarDatos(Jugador j){
